# used in ...
# https://github.com/tylerecouture/wikiplot/blob/master/canadian-federal-polls-pre43rd.R
# https://en.wikipedia.org/wiki/2019_Canadian_federal_election#/media/File:Opinion_polling_during_the_pre-campaign_period_of_43rd_Canadian_federal_election.svg
library(reshape)
library(RCurl)
library(XML)
library(stringr)
